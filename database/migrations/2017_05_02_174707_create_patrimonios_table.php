...
class CreatePatrimoniosTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Patrimonios", 'patrimonios', 'numero', 'fa-cube', [
            ["numero", "Numero", "Integer", false, "", 0, 11, false],
            ["tipo", "Tipo de Patrimonio", "Dropdown", false, "", 0, 0, false, ["M\u00c1QUINA","VEICULO","CERCA"]],
            ["valor", "Valor", "Decimal", false, "", 0, 11, false],
