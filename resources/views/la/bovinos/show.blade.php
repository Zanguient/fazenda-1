...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $bovino->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Bovinos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/bovinos/'.$bovino->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Bovinos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.bovinos.destroy', $bovino->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/bovinos') }}" data-toggle="tooltip" data-placement="right" title="Back to Bovinos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'foto')
						@la_display($module, 'raca')
						@la_display($module, 'grau_sangue')
					</div>
				</div>
			</div>
		</div>
		<div role="tabpanel" class="tab-pane fade in p20 bg-white" id="tab-timeline">
			<h1>Arvore genealogica</h1>
		</div>
