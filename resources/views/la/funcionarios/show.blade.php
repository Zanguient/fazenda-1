...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $funcionario->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Funcionarios", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/funcionarios/'.$funcionario->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Funcionarios", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.funcionarios.destroy', $funcionario->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/funcionarios') }}" data-toggle="tooltip" data-placement="right" title="Back to Funcionarios"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'telefone_residencial')
						@la_display($module, 'telefone_comercial')
						@la_display($module, 'city')
						@la_display($module, 'bairro')
						@la_display($module, 'numero')
						@la_display($module, 'rua')
						@la_display($module, 'complemento')
